...
function HeaderComponent({changeHandler , currentCity , clickHandler}) {
  return (
    <header className="bg-white h-[100px] flex justify-between items-center px-[43px] shadow-lg sticky top-0">
      <div className="relative">
        ...
        />
        <CiSearch
          className="absolute top-[30%] left-[2%] text-[20px] text-blue-800"
